                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" 
                                        v-model="nombre" class="form-control" placeholder="Nombre de Cliente">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select 
                                        v-model="tipo_documento" class="form-control">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" 
                                        v-model="num_documento" class="form-control" placeholder="Numero Documento">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" 
                                        v-model="direccion" class="form-control" placeholder="Nombre de Cliente">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <select class="form-control" v-model="idrol">
                                            ...
                                            <option v-for="rol in arrayRol" :key="rol.id" :value="rol.id" v-text="rol.nombre">Seleccione</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="password" v-model="password"  class="form-control" placeholder="Crear Contraseña">
                                    </div>
                                </div>
