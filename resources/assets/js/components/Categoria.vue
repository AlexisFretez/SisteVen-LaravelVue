                ...
                <div class="modal-dialog modal-primary modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-9">
                                        <input type="text" 
                                        v-model="nombre" class="form-control" placeholder="Nombre de categoría">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" v-if="tipoAccion==2" @click="actualizarCategoria()" class="btn btn-success">Actualizar</button>
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
        ...
        methods : {
            ...
            desactivarCategoria(id){
                const swalWithBootstrapButtons = Swal.mixin({
                    ...
                    title: 'Esta seguro?',
                    text: "de Desactivar la Categoria!",
                    icon: 'warning',
