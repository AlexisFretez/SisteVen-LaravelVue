...
--
-- Servidor: localhost
-- Tiempo de generación: 19-07-2021 a las 03:45:33
...
(1, 1, '01', 'Alrticulo', '1000.00', 320, 'asasa', 1, '2021-07-02 07:01:48', '2021-07-02 07:01:48'),
(2, 1, '1', 'Pan Duro', '20000.00', 200, 'Pan de Ayer', 1, '2021-07-13 07:00:01', '2021-07-13 07:00:01');
...
(1, 'Algodon', 'algodon de azucar', 1, '2021-07-02 07:00:48', '2021-07-02 07:00:48');
...
CREATE TABLE `ingresos` (
  ...
  `serie_comprobante` varchar(7) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
  `num_comprobante` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL,
...
(1, 6, 5, 'Boleta', '01', '001', '2021-07-01 22:58:47', '0.10', '100.00', 'Registrado', '2021-07-02 02:59:37', '2021-07-02 02:59:38');
...
(2, '2021_06_11_014809_create_categorias_table', 1),
(3, '2021_06_17_000857_create_articulos_table', 1),
(4, '2021_06_22_021026_create_personas_table', 1),
(5, '2021_06_23_021728_create_proveedores_table', 1),
(6, '2021_06_24_023932_create_roles_table', 1),
(7, '2021_06_25_000000_create_users_table', 1),
(8, '2021_07_02_012906_create_ingresos_table', 1),
(9, '2021_07_02_013046_create_detalle_ingresos_table', 1);
...
(1, 'alexis', 'DNI', '4986125', 'itaugu', '0971516217', 'alexisfretez@gmail.com', '2021-07-02 06:51:07', '2021-07-02 06:51:07'),
(5, 'alexis Fretez', 'DNI', NULL, NULL, NULL, NULL, '2021-07-02 06:53:49', '2021-07-02 06:54:30'),
(6, 'MI CASA', 'RUC', '5545', '5555', '455', 'alexisfretez@gmail.com', '2021-07-02 06:57:46', '2021-07-10 07:08:58'),
(7, 'ceha', 'RUC', '123', 'itaugua', '11222', 'alexisfretez@gmail.com', '2021-07-10 07:50:23', '2021-07-10 07:50:23');
...
(3, 'Almacenero', 'Almacenero de Area Compras', 1);
...
CREATE TABLE `users` (
  ...
  `condicion` tinyint(1) NOT NULL DEFAULT '3',
...
(5, 'ale', '$2y$10$a/m3myZDj/R.v8cJ2U9/A.Pu4e98ADYTMY91iBD/qy/XeMaSOMJQm', 1, 1, 'CrUiBXTDRl0URH684KaCdfSf7iPMzfq2FG50VZIHoY2V3zB9vBekbx9t9UQg');
